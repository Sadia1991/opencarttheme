...
class __TwigTemplate_3e4c6c4c9217c68ff34f1a996c62f0cdee65c70677488c807af7199c2d825f18 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <ul class=\"nav\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["category"]) {
            ...
            if (twig_get_attribute($this->env, $this->source, $context["category"], "children", [], "any", false, false, false, 7)) {
                // line 8
                echo "      <li class=\"dropdown menu-item yamm mega-menu\">
          ";
            } else {
                // line 10
                echo "      <li class=\"dropdown menu-item mega-menu\">
          ";
            }
            // line 12
            echo "        <a href=\"";
