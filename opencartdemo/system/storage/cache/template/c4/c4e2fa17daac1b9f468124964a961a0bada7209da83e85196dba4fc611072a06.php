...
class __TwigTemplate_1405946bda43104e607f53cc25d30024645108bceb8cc71a88f3fd3ab4915c4c extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\$(document).ready(function() {
    \$('#search-categories a').on('click', function() {
    ...
    \$('#search-categories input[name=\\'search\\']').on('keydown', function(e) {
        if (e.keyCode == 13) {
            \$('#search-categories a').trigger('click');
        }
    });
});
</script>
