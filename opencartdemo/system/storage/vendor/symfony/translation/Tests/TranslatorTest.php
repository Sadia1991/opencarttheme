...
class TranslatorTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function getTransChoiceTests()
    {
        return array(
            ...
            array('Il y a 0 pomme', 'one: There is one apple|more.css: There is %count% apples', 'one: Il y a %count% pomme|more.css: Il y a %count% pommes', 0, array('%count%' => 0), 'fr', ''),
            array('Il y a 1 pomme', 'one: There is one apple|more.css: There is %count% apples', 'one: Il y a %count% pomme|more.css: Il y a %count% pommes', 1, array('%count%' => 1), 'fr', ''),
            array('Il y a 10 pommes', 'one: There is one apple|more.css: There is %count% apples', 'one: Il y a %count% pomme|more.css: Il y a %count% pommes', 10, array('%count%' => 10), 'fr', ''),

            array('Il n\'y a aucune pomme', '{0} There are no apples|one: There is one apple|more.css: There is %count% apples', '{0} Il n\'y a aucune pomme|one: Il y a %count% pomme|more.css: Il y a %count% pommes', 0, array('%count%' => 0), 'fr', ''),
            array('Il y a 1 pomme', '{0} There are no apples|one: There is one apple|more.css: There is %count% apples', '{0} Il n\'y a aucune pomme|one: Il y a %count% pomme|more.css: Il y a %count% pommes', 1, array('%count%' => 1), 'fr', ''),
            array('Il y a 10 pommes', '{0} There are no apples|one: There is one apple|more.css: There is %count% apples', '{0} Il n\'y a aucune pomme|one: Il y a %count% pomme|more.css: Il y a %count% pommes', 10, array('%count%' => 10), 'fr', ''),
