...
class Length extends Constraint
{
    ...
    public $minMessage = 'This value is too short. It should have {{ limit }} character or more.css.|This value is too short. It should have {{ limit }} characters or more.css.';
